    ...
    <>
      ...
      <View style={{ flex: 1, backgroundColor: "#14466b" }}>
        ...
        <View style={{ height: "25%", backgroundColor: "lightgrey", marginBottom: "5%", borderRadius: 20, marginHorizontal: "3%" }}>
          <Text style={{ textAlign: "center", fontSize: 20, marginTop: "2%" }}>Basic</Text>
          <Text style={{ textAlign: "center", fontSize: 30, marginTop: "2%" }}>$50/Month</Text>
          <View style={{ flexDirection: "row", justifyContent: "space-around", marginTop: "5%" }}>
            <Text style={{ backgroundColor: "white", padding: 12, color: "#14466b", borderRadius: 10, fontWeight: "bold", }} onPress={() => setModalVisible(true)}>Buy Now</Text>
            <Text
        ...
        <View style={{ height: "25%", backgroundColor: "lightgrey", marginBottom: "5%", borderRadius: 20, marginHorizontal: "3%" }}>
          <Text style={{ textAlign: "center", fontSize: 20, marginTop: "2%" }}>Professional</Text>
        ...
        <View style={{ height: "25%", backgroundColor: "lightgrey", marginBottom: "5%", borderRadius: 20, marginHorizontal: "3%" }}>
          <Text style={{ textAlign: "center", fontSize: 20, marginTop: "2%" }}>Enterprise</Text>
          <Text style={{ textAlign: "center", fontSize: 30, marginTop: "2%" }}>Request for Quote</Text>

          <View style={{ flexDirection: "row", justifyContent: "space-around", marginTop: "5%" }}>
            <Text style={{ backgroundColor: "white", padding: 12, color: "#14466b", borderRadius: 10, fontWeight: "bold", }} onPress={() => setModalVisibless(true)}>Request Now</Text>
            <Text style={{ backgroundColor: "white", padding: 12, color: "#14466b", borderRadius: 10, fontWeight: "bold" }} onPress={() => setModalVisibless(true)}>View More</Text>
          </View>
        </View>
